...
public class ErrorCode {
	...
	public static final String AUTH_ILLEGAL_USER_CODE = "30007";//非法的用户名
	public static final String AUTH_EMPTY_USER_CODE = "30008";//用户登录名为空
	public static final String AUTH_EMPTY_PASSWORD = "30009";//密码为空
	public static final String AUTH_INVALID_LOGIN_OR_PASSWORD = "30010";//用户名或密码不正确
